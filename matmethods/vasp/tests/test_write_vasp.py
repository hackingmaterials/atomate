...
from matmethods.vasp.input_sets import StructureOptimizationVaspInputSet, StaticVaspInputSet, write_preserved_incar
...
class TestWriteVasp(unittest.TestCase):
    ...
    def test_preserve_incar(self):
        ...
        write_preserved_incar(vis, new_structure,
