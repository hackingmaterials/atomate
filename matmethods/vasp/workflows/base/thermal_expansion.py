...
from matmethods.vasp.firetasks.parse_outputs import ThermalExpansionCoeffTask
...
def get_wf_thermal_expansion(structure, vasp_input_set=None, vasp_cmd="vasp", deformations=None,
