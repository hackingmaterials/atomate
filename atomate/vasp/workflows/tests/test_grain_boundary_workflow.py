...
from atomate.vasp.workflows.base.grain_boundary import get_wf_gb, get_gb_fw
from atomate.utils.testing import AtomateTest
from pymatgen import Structure, Molecule, Lattice
from pymatgen.analysis.gb.gb import Gb, GBGenerator
from pymatgen.io.vasp.sets import MVLSlabSet, MVLGBSet
...
class TestGrainboundaryWorkflow(AtomateTest):
    def setUp(self, lpad=True):
        ...
        gb_111_s3 = gbg.gb_from_parameters(**gb_gen_params_s3)
    ...
    def _simulate_vasprun_start_from_bulk(self, wf):
    ...
    def _simulate_vasprun_start_from_gb(self, wf):
        reference_dir = os.path.abspath(os.path.join(ref_dir, "grain_boundary_wf"))
