...
class VaspCalcDb(CalcDb):
    ...
    def insert_task(self, task_doc, insert_dos=False, insert_bs=False):
        """
        ...
        Args:
            ...
            insert_dos (bool): attempt to insert dos in task_doc into Gridfs
            insert_bs (bool): attempt to insert bandstructure in task_doc into Gridfs
        ...
        if insert_dos and "calcs_reversed" in task_doc:
        ...
        if insert_bs and "calcs_reversed" in task_doc:
