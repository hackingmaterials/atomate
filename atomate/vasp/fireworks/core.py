...
class SurfCalcFW(Firework):
    ...
    def __init__(self, structure, calc_type, mpid, k_product=50, miller_index=None,
        ...
        """
        Args:
            calc_type (str): Type of calculation, options are: "conventional_unit_cell",
                "oriented_unit_cell", "slab_cell", or "static_slab_cell" for getting the
                work function.
        """
        ...
        self.reconstruction_name = reconstruction_name
        self.shift = shift
        ...
        tasks = OptimizeFW(structure, name=self.get_name(), vasp_input_set=mvl,
                           vasp_cmd=vasp_cmd, override_default_vasp_params=None,
                           ediffg=ediffg, db_file=None, force_gamma=True,
                           job_type="double_relaxation_run",
                           max_force_threshold=RELAX_MAX_FORCE,
                           auto_npar=">>auto_npar<<", parents=None,
