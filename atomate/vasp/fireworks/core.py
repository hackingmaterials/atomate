...
from atomate.vasp.firetasks.write_inputs import WriteNormalmodeDisplacedPoscar, \
    ...
    WriteVaspFromIOSetFromInterpolatedPOSCAR, WriteVaspNMRFromPrev
...
class NMRFW(Firework):
    ...
    def __init__(self, structure=None, mode="cs", isotopes=None, name="nmr tensor",
                 prev_calc_dir=None, vasp_cmd="vasp", copy_vasp_outputs=True, db_file=None,
                 parents=None, **kwargs):
        """
